...
function pcData = HDLS3AnalyserFun( DataDir, R, T )
IS_SHOW = 0;
if nargin == 0
    clc; close all;
    nFrm = 200;
    DataRoot = 'C:\Users\lucaswang\Desktop\IVFC2019\HDL_S3\Calibration_File\Record-2019-08-21-18-53-59UnderGround\BinaryData';
...
ParaDir = 'D:\MatlabPros\CommonFunctions\Velodyne\calibFiles\HDLS3CalibNew.txt';
