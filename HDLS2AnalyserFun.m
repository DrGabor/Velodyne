...
function pcData = HDLS2AnalyserFun( DataDir, R, T )
if nargin == 0 
...
% LaserId  RotCorrAng  VertCorrAng  DistCorr  VertOffset HorizOffset;
tmp = load('D:\MatlabPros\CommonFunctions\Velodyne\calibFiles\HDLS2Calib.txt'); 
